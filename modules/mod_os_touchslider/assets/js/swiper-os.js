...
(function (global, factory) {
  ...
  function slideTo (index, speed, runCallbacks, internal) {
    ...
    if(params.setupAnimation != undefined  && typeof(params.setupAnimation.end) != "undefined" && 
  ...
  function slideNext (speed, runCallbacks, internal) {
    ...
    var container =  params.el ;
    if(typeof(params.setupAnimation != undefined && params.setupAnimation.end) != "undefined" && params.setupAnimation.end.length){
      jQuerOs(params.setupAnimation.end).each(function(index, animationClass) {
  ...
  function slidePrev (speed, runCallbacks, internal) {
    ...
    var container =  params.el ;
    if(params.setupAnimation != undefined  && typeof(params.setupAnimation.end) != "undefined" && params.setupAnimation.end.length){
        jQuerOs(params.setupAnimation.end).each(function(index, animationClass) {
            jQuerOs(container+' .'+params.slideActiveClass).animateCssSlide(animationClass, true);
        });
  ...
  var Autoplay = {
    run: function run() {
      ...
      if(swiper.params.imageFullTime[jQuerOs(swiper.slides.eq(swiper.activeIndex)[0]).attr("data-image-id")]){
