...
class ModVinaArticlesAccordionHelper
{
	public static function getList(&$params)
	{
		...
		$showFullText		= $params->get('showFullText', 0);
		...
		foreach($items as &$item)
		{
			...
			$fulText = $item->introtext . $item->fulltext;
			...
			$item->displayIntrotext = ($showFullText) ? $fulText : $item->displayIntrotext;
