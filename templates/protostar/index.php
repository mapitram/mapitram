	...
	<div class="body" id="top">	
		...
		<header class="header" role="banner">			
				<div class="header-inner clearfix">
					...
					<div class="header-search pull-right">
						<jdoc:include type="modules" name="menus-1" style="none"/>
					</div>
				</div>
		...
		<div class="container2<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
		...
		<div class="container3<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
